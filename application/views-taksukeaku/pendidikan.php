                                            ...
                                            if( $pendidikan ) :
                                            	...
                                            	foreach ($pendidikan as $data) : $i++; ?>
                                                    <tr>
                                                        ...
                                                        <td><a class="btn-action btn btn-primary" href="<?php echo base_url('c_Pendidikan/edit_pendidikan/'.$data->ID); ?>">Edit</a></td>
                                                        <td><a class="btn-action btn btn-danger" href="<?php echo base_url('c_Pendidikan/delete_pendidikan/'.$data->ID); ?>">Delete</a></td>
                                                    </tr>
                                                    <?php
                                                endforeach;
                                            else : ?>
