...
if ($perawat) {
    ...
    foreach ($perawat as $data) {
        ...
        echo '</td>
                                                        <td>' . $data['phone'] . '</td>
                                                        <td><a href="' . base_url('c_Perawat/edit_perawat/' . $data['ID']) . '" class="btn-action btn btn-primary btn-edit">Edit</a></td>
                                                        <td><a href="#" class="btn-action btn btn-danger btn-delete" data-id="' . $data['ID'] . '">Delete</a></td>
                                                    </tr>';
