                ...
                <div class="col-md-6">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form method="POST" action="<?php echo base_url('c_Pendidikan/update_pendidikan'); ?>" role="form">
                                <input type="hidden" name="ID" value="<?php echo $pendidikan->ID; ?>" />
                                <div class="form-group">
                                    <label for="title">Title</label>
                                    <input type="text" class="form-control" id="title" name="name" value="<?php echo $pendidikan->name; ?>" placeholder="Title" />
                                </div>
                                <div class="form-group">
                                    <label for="slug">Slug</label>
                                    <input type="text" class="form-control" id="slug" name="slug" value="<?php echo $pendidikan->slug; ?>" placeholder="Slug" />
                                </div>
